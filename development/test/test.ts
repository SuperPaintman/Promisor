...
describe("#delay", () => {
    ...
    describe("Promisor `new`", () => {
        ...
        it("should return after 500ms with value", function() {
            ...
            return new Promisor().delay(500, 42)
                .then((result) => {
                    const end = new Date().getTime();
                    const delta = end - start;
    ...
    describe("Promisor `new`", () => {
        it("should return 9 value by 3 series after 900ms", function() {
            ...
            for (let i = 0, len = 9; i < len; i++) {
                (function(promises, i) {
                    promises.push(function() {
                        return new Promisor().delay(300).then(() => {
                            return i;
                        });
                    });
                })(promises, i);
            ...
            return new Promisor().allSeries(promises, 3)
                .then((result) => {
                    const end = new Date().getTime();
                    const delta = end - start;
            ...
            for (let i = 0, len = 9; i < len; i++) {
                (function(promises, i) {
                    promises.push(function() {
                        ...
                        return new Promisor().delay(100 * (i + 1)).then(() => {
                            return i;
                        });
                    });
                })(promises, i);
        ...
        it("should return 9 value by 3 series and delay by 100 after 2100ms", function() {
            ...
            return new Promisor().allSeries(promises, 3, 100)
                .then((result) => {
                    const end = new Date().getTime();
                    const delta = end - start;
